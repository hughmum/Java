...
- **<font color='DodgerBlue'>注册一个RestTemplate的实例到Spring容器</font>**
- **<font color='red'>修改order-service服务中的OrderService类中的queryOrderById方法，根据Order对象中的userId查询User</font>**
...
**<font color='DodgerBlue'>默认的实现就是ZoneAvoidanceRule，是一种轮询方案</font>**
...
> **注意**，<font color='red'>一般用默认的负载均衡规则，不做修改。</font>
...
> 注意： 配置文件就一个，改一次配置文件，然后启动不同的项目才能实现集群
